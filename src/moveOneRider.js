 ...
 * @returns {number} finalYPosition - the y position of the rider
 */
...
/**
 * This checks for inclines, declines, feedzones, end of track
 * @param {string} rider
 * @param {number} potentialMove
 * @param {array of arrays} trackData
 * @returns {number} move - adjusted move
 */
...
/**
 * tests all potential spaces that could be moved into for inclines
 * @param {string} rider
 * @param {number} potentialPosition
 * @param {array of arrays} trackData
 * @returns {array of booleans} inclineArray - list of booleons indicating presense of incline
 */
